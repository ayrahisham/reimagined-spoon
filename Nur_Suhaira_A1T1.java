...
// Rank values from Two, Three ……Ten, Jack, King, Queen and Ace (in that order). 
...
class Nur_Suhaira_A1T1
{
    ...
    public static PlayingCard [][] constructArray (PlayingCard pc [][])
    {
        SuitEnum se;
        RankEnum re;
    ...
    public static void displayArray (PlayingCard pc [][])
    {
        for (int row = 0; row < 4; row++)
        {
            for (int column = 0; column < 13; column++)
    ...
    {
        PlayingCard [][] pc = new PlayingCard [4][52];
        
        Nur_Suhaira_A1T1.constructArray(pc);
        Nur_Suhaira_A1T1.displayArray(pc);
